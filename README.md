...
| # |	Run Date |	Run By |	Results |
| --- | --- | --- | --- |
| 1 | 10/08/2018 | Developers | The "Build Mode" play option is non-functional |			
| 2 | 10/09/2018 | Developers | The "Build Mode" play option is functional. The highscore menu appears when prompted |			
| 3 | 10/12/2018 | QA Testers | The "Story Mode" play option leads to the "Build Mode" menu |
| 4 | 10/13/2018 | QA Testers | The "Story Mode" menu appears when "Story Mode is selected, but no other options are functional |
| 5 | 10/17/2018 | QA Testers | The "New Game" option leads to "Build Mode"'s gameplay |
| 6 | 10/19/2018 | Pilot Testers | All menus work correctly. There is no way to get out of the "Load Game" menu without choosing a load file |
| 7 | 10/20/2018 | Pilot Testers | All correct menus appear in the correct area with the proper commands |
